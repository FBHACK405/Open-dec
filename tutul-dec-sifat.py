...
def uaku():
	try:
		...
		a=requests.get('https://github.com/FBHACK405/Open-dec/blob/main/Appoval.txt').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/FBHACK405/Open-dec/blob/main/Appoval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
